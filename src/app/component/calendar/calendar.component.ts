...
export class CalendarComponent {
  ...
  constructor(private flightService : FlightService, private datePipe: DatePipe ){
    ...
    this.cheapPrice = this.flights.sort(function(a, b){return b.price - a.price})
    this.flights.forEach(element => {

      this.events.push(
        {
          start: startOfDay(new Date(datePipe.transform(element.departure, 'yyyy-MM-dd'))),
          title: "Rp." + element.price,
          color: colors.blue,
